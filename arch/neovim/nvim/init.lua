...
vim.keymap.set('n', '<C-y>', quickfix, { noremap = true, silent = true })
vim.keymap.set('n', '<leader>tn', function()
  vim.fn.setenv('XDEBUG_TRIGGER', true)
  require('neotest').run.run()
end)

-- Bind the function to a command
-- vim.api.nvim_create_user_command('GenPHPDoc', generate_phpdoc, { nargs = 0 })
